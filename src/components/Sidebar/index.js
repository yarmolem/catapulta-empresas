...
const Sidebar = ({ show, handleClick }) => {
  return (
    <div
      className={`w-full  md:w-52 h-screen flex flex-col border-r border-gray-400 shadow-xl 
    ...
    >
      <img
        className="sm:w-4/5 my-8 self-center hidden md:block"
        src={logo}
      ></img>
        ...
        <ul className="flex flex-col md:pl-2  ">
          ...
          <li className=" pl-1 py-3 pmd:rounded-l-full pbg-gray-100  ">
            ...
            >
              ...
              <span className="text-2xl sm:text-base ml-2  text-whites">
                Dashboard
              </span>
            </Link>
          </li>
          ...
          <li className="flex  items-center  pl-1 py-3   ">
            ...
            <span className="text-2xl sm:text-base ml-2">Gestión de Q&A</span>
          </li>
        </ul>
      </nav>
    </div>
